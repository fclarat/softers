		...
		<div class="container">
			<div class="row">
				<div class="logo col-md-4">
					<div>
						<a href="#">
							<img src="images/logo.png" alt="Softers">
						</a>
					</div>
				</div>
				<div class="col-md-8">
		...
		<div class="line3">
			<div class="container">
				...
				<div class="row Ama">
					...
					<h3>Proyectos</h3>
					<p>Casos de éxito de aplicaciones web complejas solucionadas de una manera simple.</p>
					</div>
				</div>
			</div>
		</div>          
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-xs-12 cont">
					<ul>
						<li><a href="#"><i class="fa fa-envelope"></i>hola@softers.com.ar</li></a>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row downLine">
					<div class="col-md-6 text-left copy">
						<p>Copyright &copy; 2017 Softers. All Rights Reserved.</p>
					</div>
